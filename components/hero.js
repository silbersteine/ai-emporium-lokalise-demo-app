          ...
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                ...
                <span>{t('hero_view_on_github')}</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-gray-400 dark:text-gray-400" aria-label={t('hero_logo_amazon_aria')}>
              <AmazonLogo />
            </div>
            <div className="text-gray-400 dark:text-gray-400" aria-label={t('hero_logo_verizon_aria')}>
              <VerizonLogo />
            </div>
            <div className="text-gray-400 dark:text-gray-400" aria-label={t('hero_logo_microsoft_aria')}>
              <MicrosoftLogo />
            </div>
            <div className="pt-1 text-gray-400 dark:text-gray-400" aria-label={t('hero_logo_netflix_aria')}>
              <NetflixLogo />
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400" aria-label={t('hero_logo_sony_aria')}>
              <SonyLogo />
            </div>
          </div>
        </div>
